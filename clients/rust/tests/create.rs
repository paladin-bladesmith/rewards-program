...
use paladin_rewards_program_client::{accounts::Counter, instructions::CreateBuilder};
...
#[tokio::test]
async fn create() {
    let mut context = ProgramTest::new("solana_program_rewards", paladin_rewards_program_client::ID, None)
        .start_with_context()
        .await;
